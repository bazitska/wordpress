...
function acf_ficha_empleado_block(){

  /** Comprobamos si existe la función */
  ...
  if( function_exists('acf_register_block') ) {
    ...
    acf_register_block(
      array(
        'name'				=> 'ficha-empleado',
        'title'				=> __('Ficha de empleado'),
        'description'		=> __('Plantilla para la ficha de un empleado'),
        'render_template'	=> 'templates/blocks/ficha-empleado/block-ficha-empleado.php',
        'category'			=> 'layout',
        'icon'				=> 'excerpt-view',
        'keywords'			=> array( 'ficha empleado' , 'ficha', 'empleado')
      )
      );
...
add_action('acf/init', 'acf_ficha_empleado_block');
